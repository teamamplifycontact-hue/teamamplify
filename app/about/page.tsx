  ...
  return (
    <>
      <div className="flex flex-col min-h-screen bg-white">
        ...
        <main className="flex-1 pb-[160px] px-8">
          ...
          {/* コンセプト */}
          <section className="max-w-[620px] mx-auto">
            ...
            <div className="mt-14 space-y-6 text-[17px] leading-[2] font-semibold">
              ...
              <p>
                ...
                that goes beyond competing at the highest level to weave gaming
                into our daily lives and local communities.
              </p>

              <p>
                The instant thrill of a player's victory, the shared excitement
                that connects us with our fans—we use the power of design to
                amplify these experiences, bringing an innovative gaming
                lifestyle to everyone who loves the game.
              </p>
          ...
          <section className="max-w-[620px] mx-auto mt-40">

            <h2 className="text-[52px] font-black mb-10">
              代表
            </h2>
            ...
            <div className="flex flex-col md:flex-row gap-10">
              ...
              <div>
                ...
                <div className="space-y-4 text-[16px] leading-[2]">
                  ...
                  <p>
                    退社・独立を経て、現在はeSportsチーム
                    「Team Amplify」の代表を務める。
                  </p>
