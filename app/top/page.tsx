      ...
      <main>
        ...
        <section className="py-[140px] bg-white">
          <div className="max-w-[1320px] mx-auto">
            <h2 className="text-[42px] font-black mb-14">NEWS</h2>
            ...
            <div className="grid grid-cols-3 gap-x-10 gap-y-16">
              ...
              <article className="group cursor-pointer">
                ...
                <p className="mt-3 text-sm text-neutral-500">2026.06.03</p>
              </article>
              ...
              <article className="group cursor-pointer">
                ...
                <p className="mt-3 text-sm text-neutral-500">2026.06.01</p>
              </article>
              ...
              <article className="group cursor-pointer">
                ...
                <p className="mt-3 text-sm text-neutral-500">2026.05.29</p>
              </article>
              ...
              <article className="group cursor-pointer">
                ...
                <p className="mt-3 text-sm text-neutral-500">2026.05.01</p>
              </article>
          ...
          <div className="max-w-[1320px] mx-auto">
            <div className="flex items-center justify-between mb-10">
              <div>
                ...
                <h2 className="text-[48px] font-black mt-2">Amplify STORE</h2>
              </div>
        ...
        <section className="py-[140px] bg-[#f7f7f7]">
          <div className="max-w-[1320px] mx-auto">
            <div className="text-center mb-16">
              ...
              <h2 className="text-[48px] font-black mt-2">PARTNER</h2>
            </div>
